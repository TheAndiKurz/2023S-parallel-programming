...
static void norm2u3(void* or, int n1, int n2, int n3, double* rnm2, double* rnmu, int nx, int ny,
                    int nz);
...
int main() {
    ...
    print_results(Class, nx[lt], ny[lt], nz[lt], nit, t, mflops, "          floating point",
    ...
    add_time("mystery application 9.b remove 8.", threads, time);
...
#pragma omp parallel for private(i3, i2, i1, r1, r2) shared(u, c, r) schedule(static)
    for(i3 = 1; i3 < n3 - 1; i3++) {
        for(i2 = 1; i2 < n2 - 1; i2++) {
            for(i1 = 0; i1 < n1; i1++) {
                r1[i1] =
                    r[i3][i2 - 1][i1] + r[i3][i2 + 1][i1] + r[i3 - 1][i2][i1] + r[i3 + 1][i2][i1];
                r2[i1] = r[i3 - 1][i2 - 1][i1] + r[i3 - 1][i2 + 1][i1] + r[i3 + 1][i2 - 1][i1] +
                         r[i3 + 1][i2 + 1][i1];
            }
            for(i1 = 1; i1 < n1 - 1; i1++) {
                u[i3][i2][i1] = u[i3][i2][i1] + c[0] * r[i3][i2][i1] +
...
#pragma omp parallel for private(i3, i2, i1, u1, u2) shared(n3, n2, n1, u, v, r, a) schedule(static)
    for(i3 = 1; i3 < n3 - 1; i3++) {
        for(i2 = 1; i2 < n2 - 1; i2++) {
            for(i1 = 0; i1 < n1; i1++) {
                u1[i1] =
                    u[i3][i2 - 1][i1] + u[i3][i2 + 1][i1] + u[i3 - 1][i2][i1] + u[i3 + 1][i2][i1];
                u2[i1] = u[i3 - 1][i2 - 1][i1] + u[i3 - 1][i2 + 1][i1] + u[i3 + 1][i2 - 1][i1] +
                         u[i3 + 1][i2 + 1][i1];
            }
            for(i1 = 1; i1 < n1 - 1; i1++) {
                r[i3][i2][i1] =
        ...
        for(j2 = 1; j2 < m2j - 1; j2++) {
            ...
            for(j1 = 1; j1 < m1j; j1++) {
                ...
                x1[i1] = r[i3 + 1][i2][i1] + r[i3 + 1][i2 + 2][i1] + r[i3][i2 + 1][i1] +
                         r[i3 + 2][i2 + 1][i1];
                y1[i1] =
                    r[i3][i2][i1] + r[i3 + 2][i2][i1] + r[i3][i2 + 2][i1] + r[i3 + 2][i2 + 2][i1];
            }
            ...
            for(j1 = 1; j1 < m1j - 1; j1++) {
                ...
                y2 = r[i3][i2][i1 + 1] + r[i3 + 2][i2][i1 + 1] + r[i3][i2 + 2][i1 + 1] +
                     r[i3 + 2][i2 + 2][i1 + 1];
                x2 = r[i3 + 1][i2][i1 + 1] + r[i3 + 1][i2 + 2][i1 + 1] + r[i3][i2 + 1][i1 + 1] +
                     r[i3 + 2][i2 + 1][i1 + 1];
            ...
            for(i2 = 1; i2 <= mm2 - 1; i2++) {
                ...
                for(i1 = 1; i1 <= mm1 - 1; i1++) {
                    u[2 * i3 - d3 - 1][2 * i2 - t2 - 1][2 * i1 - t1 - 1] =
                        u[2 * i3 - d3 - 1][2 * i2 - t2 - 1][2 * i1 - t1 - 1] +
                        0.25 * (z[i3 - 1][i2][i1] + z[i3 - 1][i2 - 1][i1] + z[i3 - 1][i2][i1 - 1] +
                                z[i3 - 1][i2 - 1][i1 - 1]);
                }
            }
        }
            ...
            for(i2 = d2; i2 <= mm2 - 1; i2++) {
                ...
                for(i1 = 1; i1 <= mm1 - 1; i1++) {
                    u[2 * i3 - t3 - 1][2 * i2 - d2 - 1][2 * i1 - t1 - 1] =
                        u[2 * i3 - t3 - 1][2 * i2 - d2 - 1][2 * i1 - t1 - 1] +
                        0.25 * (z[i3][i2 - 1][i1] + z[i3][i2 - 1][i1 - 1] + z[i3 - 1][i2 - 1][i1] +
                                z[i3 - 1][i2 - 1][i1 - 1]);
                }
            }
            for(i2 = 1; i2 <= mm2 - 1; i2++) {
                for(i1 = d1; i1 <= mm1 - 1; i1++) {
                    u[2 * i3 - t3 - 1][2 * i2 - t2 - 1][2 * i1 - d1 - 1] =
                        u[2 * i3 - t3 - 1][2 * i2 - t2 - 1][2 * i1 - d1 - 1] +
                        0.25 * (z[i3][i2][i1 - 1] + z[i3][i2 - 1][i1 - 1] + z[i3 - 1][i2][i1 - 1] +
                                z[i3 - 1][i2 - 1][i1 - 1]);
                }
                for(i1 = 1; i1 <= mm1 - 1; i1++) {
                    u[2 * i3 - t3 - 1][2 * i2 - t2 - 1][2 * i1 - t1 - 1] =
                        ...
                        0.125 * (z[i3][i2][i1] + z[i3][i2 - 1][i1] + z[i3][i2][i1 - 1] +
                                 z[i3][i2 - 1][i1 - 1] + z[i3 - 1][i2][i1] + z[i3 - 1][i2 - 1][i1] +
...
#pragma omp parallel for private(i2, i1) shared(n3, n2, u)
    for(i3 = 1; i3 < n3 - 1; i3++) {
        for(i2 = 1; i2 < n2 - 1; i2++) {
...
// NOTE: seems to have negative impact on performance to parallelize 
// #pragma omp parallel for private(i2, i1) shared(n3, n2, u)
    for(i2 = 0; i2 < n2; i2++) {
        for(i1 = 0; i1 < n1; i1++) {
...
//---------------------------------------------------------------------
// NOTE: this bubble sort? algorithm is not easily parallelizable
static void bubble(double ten[][2], int j1[][2], int j2[][2], int j3[][2], int m, int ind) {
    double temp;
    int i, j_temp;
...
#pragma omp parallel for private(i2, i1) shared(z)
    for(i3 = 0; i3 < n3; i3++) {
        for(i2 = 0; i2 < n2; i2++) {
            for(i1 = 0; i1 < n1; i1++) {
                z[i3][i2][i1] = 0.0;
